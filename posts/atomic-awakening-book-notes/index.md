...
##### Valerio and Duckworth's Search

*   **10:30 p.m.:** **Ed Valario** (HP in charge of SL-1) and **Paul Duckworth** (Combustion Engineering) arrived.
*   They donned air packs and entered the silo.
*   Their detector registered 1,500 rads per hour, allowing for only a short exposure time.
*   Valario heard moaning and found **Jack Burns** on the floor, severely injured.
*   **Richard McKinley** was found dead, thrown against a concrete block.
*   **Dick Legg** was not visible.
