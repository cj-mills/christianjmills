...
![create_project](\images\barracuda-posenet-tutorial\create_project.jpg)
...
![create_video_player](\images\barracuda-posenet-tutorial\create_video_player.jpg)
...
![create_folder](\images\barracuda-posenet-tutorial\create_folder.jpg)

Double-click the `Videos` folder to open it.

Drag and drop the two video files into the `Videos` folder.

![video_file_assets](\images\barracuda-posenet-tutorial\video_file_assets.jpg)
...
![video_clip_empty](\images\barracuda-posenet-tutorial\video_clip_empty.jpg)

![video_clip_filled](\images\barracuda-posenet-tutorial\video_clip_filled.jpg)

Tick the `Loop` checkbox in the `Inspector` tab to make the video repeat when the project is running.

![loop_video_checkbox](\images\barracuda-posenet-tutorial\loop_video_checkbox.jpg)
...
![textures_folder](\images\barracuda-posenet-tutorial\textures_folder.jpg)
...
![create_render_texture](\images\barracuda-posenet-tutorial\create_render_texture.jpg)
...
![rt_size_parameter](\images\barracuda-posenet-tutorial\rt_size_parameter.jpg)

![rt_set_resolution](\images\barracuda-posenet-tutorial\rt_set_resolution.jpg)
...
![target_texture_empty](\images\barracuda-posenet-tutorial\target_texture_empty.jpg)



![target_texture_filled](\images\barracuda-posenet-tutorial\target_texture_filled.jpg)
...
![create_quad](\images\barracuda-posenet-tutorial\create_quad.jpg)
...
![quad_scale_default](\images\barracuda-posenet-tutorial\quad_scale_default.jpg)

![quad_scale_set](\images\barracuda-posenet-tutorial\quad_scale_set.jpg)
...
![quad_position_default](\images\barracuda-posenet-tutorial\quad_position_default.jpg)

![quad_position_set](\images\barracuda-posenet-tutorial\quad_position_set.jpg)
...
![recentered_video_screen](\images\barracuda-posenet-tutorial\recentered_video_screen.jpg)
...
![select_unlit_shader](\images\barracuda-posenet-tutorial\select_unlit_shader.jpg)

![select_unlit_texture_shader](\images\barracuda-posenet-tutorial\select_unlit_texture_shader.jpg)
...
![set_main_camera_position_new](\images\barracuda-posenet-tutorial\set_main_camera_position_new.jpg)



Finally, we need to adjust the Size parameter to 540 in the `Inspector` tab.

![set_camera_size_new](\images\barracuda-posenet-tutorial\set_camera_size_new.jpg)

Now we can finally click the play button and watch the video.

![play_button](\images\barracuda-posenet-tutorial\play_button.jpg)
