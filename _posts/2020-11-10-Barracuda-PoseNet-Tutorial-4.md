...
Assuming we knew the stride, we could make it a constant  value. However, calculating it is an easy way to make sure. It also makes it less of a hassle when switching between models with different stride values. 
